...
import ar.com.coninf.doconline.rest.model.tx.TipoIva;
import ar.com.coninf.doconline.rest.model.tx.Tributo;

public class RequestActualizarItemComprobante extends Request {
	...
	public TipoIva[] getIvas() {
		return ivas;
	}
	public void setIvas(TipoIva[] ivas) {
		this.ivas = ivas;
	}
}